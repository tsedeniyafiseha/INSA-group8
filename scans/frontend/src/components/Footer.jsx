...
export default function Footer() {
  return (
    <footer className="bg-gray-200 border-t border-gray-300 mt-auto">
      <div className="max-w-6xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex items-center space-x-3 mb-4 md:mb-0">
          <img
            ...
            className="w-6 h-6 "
          />
          <span className="text-gray-900 font-bold text-xl font-poppins">
            SCNAS
          </span>
        </div>

        {}
        <nav className="flex flex-wrap justify-center space-x-4 text-gray-700 font-medium font-roboto-condensed">
          {[
            { label: "Home", to: "/" },
        ...
        {}
        <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 mt-4 md:mt-0 text-gray-600">
          ...
          <span className="text-gray-900 font-semibold text-lg font-roboto">
            Connect to AASTU
          </span>
        </div>
      </div>
      ...
      {}
      <div
        className="text-center text-gray-600 text-sm py-2"
